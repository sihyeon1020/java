...
public class String에서Char배열에옮기기3 {
	public static void main(String[] args) {
		...
		// 유효한 주민번호인지 아닌지 출력
		char[] two = new char[2];
		sno.getChars(4, 6, two, 0); //index 4, 5번 값에,two를 넣는다,0번부터 
		//원본인 String인 sno에서 4~5를 추출해서 char[]인 two에 인덱스 0부터 넣어주세요.
		System.out.println(Arrays.toString(two));
		
		int i1 = Character.getNumericValue(two[0]); //Character.getNumericValue --> char를 int로 바꿔줌
